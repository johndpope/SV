...
@Component({
  selector: 'app-your-profile-edit',
  templateUrl: './your-profile-edit.component.html',
  styleUrls: ['./your-profile-edit.component.css']
})
export class YourProfileEditComponent implements OnInit {
